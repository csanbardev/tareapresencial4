...
class controlador
{
  ...
  public function buscarTareasRango(){
    $orden = "desc"; // por defecto, el orden será descendente
    ...
    if(isset($_POST['submit']) && isset($_POST['dtfechafin']) && isset($_POST['dtfechainicio'])){
      $inicio = $_POST['dtfechainicio'];
      $fin = $_POST['dtfechafin'];
    }

    // Realizamos la consulta y almacenmos los resultados en la variable $resultModelo
    $resultModelo = $this->modelo->listarPorRango($inicio, $fin, $orden);
